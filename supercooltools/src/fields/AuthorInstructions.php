...
class AuthorInstructions extends Field
{
    ...
    {
        return Craft::t('supercooltools', 'Author Instructions');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'supercooltools/_components/fields/authorinstructions/settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'supercooltools/_components/fields/authorinstructions/input',
            [
                'name'     => $name,
                'value'    => $value,
