...
use supercool\supercooltools\fields\data\OtherDropdownData;
...
class OtherDropdown extends Dropdown
{
    ...
    {
        return Craft::t('supercooltools', 'Dropdown (Other)');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        $settingsTemplate = Craft::$app->getView()->renderTemplate('supercooltools/_components/fields/otherdropdown/settings', [
            'field' => $this
        ]);
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        return Craft::$app->getView()->renderTemplate('supercooltools/_components/fields/Otherdropdown/input', [
            'name'    => $this->handle,
            'value'   => $value,
            'options' => $options,
            'field' => $this
    ...
    public function otherValueValidation(ElementInterface $element)
    {
        ...
        {
            $element->addError($this->handle, Craft::t('supercooltools', 'You have selected "{otherLabel}" but not entered a value in this field.', ['otherLabel' => $value->label]));
        }
    }
