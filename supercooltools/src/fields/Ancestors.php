...
class Ancestors extends Entries
{
     ...
     * @var string
     */
    protected $inputTemplate = 'supercooltools/_components/fields/ancestors/input';
     ...
     * @var string
     */
    protected $settingsTemplate = 'supercooltools/_components/fields/ancestors/settings';
    ...
    {
        return Craft::t('supercooltools', 'Ancestors');
    }
